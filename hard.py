...
BOXSIZE = 60 # size of each box (height and width) in pixels
GAPSIZE = 10 # size of gap between boxes in pixels
BOARDWIDTH = 6 # number of columns of boxes on the game board
BOARDHEIGHT =6 # number of rows of boxes on the game board
